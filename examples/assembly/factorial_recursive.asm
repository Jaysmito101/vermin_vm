...
@FACTORIAL_FUNC.IF.1.CONDITION
MOV R8 R0
JZ @FACTORIAL_FUNC.IF.1.ELSE
JMP @FACTORIAL_FUNC.IF.1.BODY
@FACTORIAL_FUNC.IF.1.BODY
PUSH R5 ; SAVE THE RETURN ADDRESS
PUSH R0 ; SAVE THE PARAM
DEC R0
PUSH R0
...
PUSH R0
JMP R5 ; RETURN
@FACTORIAL_FUNC.IF.1.ELSE
MOV R1 1
PUSH R1 ; PUSH RESULT
JMP R5 ; RETURN
@FACTORIAL_FUNC.IF.1.END
; NUM TO STR FUNC
@NUM_TO_STR
MOV R2 R13
SUB R2 24
