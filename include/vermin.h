...
#define VERMIN_INSTRUCTION_PRINTREG 14
#define VERMIN_INSTRUCTION_AND      15
#define VERMIN_INSTRUCTION_OR       16
#define VERMIN_INSTRUCTION_LSHIFT   17
#define VERMIN_INSTRUCTION_RSHIFT   18
